...
const (
	...
	userId      = "benny.cao"
	playlistId  = spotify.ID("xyz")
)

var html = `
<br/>
<a href="/player/add">Add</a><br/>
...
var (
	auth  = spotify.NewAuthenticator(redirectURI, spotify.ScopePlaylistModifyPrivate, spotify.ScopePlaylistModifyPublic, spotify.ScopeUserReadCurrentlyPlaying, spotify.ScopeUserReadPlaybackState, spotify.ScopeUserModifyPlaybackState)
...
func main() {
	...
	http.HandleFunc("/player/", func(w http.ResponseWriter, r *http.Request) {
		...
		switch action {
		case "add":
			_, err = client.AddTracksToPlaylist(userId, playlistId, spotify.ID("5Yql4ooghbDqwXIvCGXsdx"))
		case "play":
			err = client.Play()
		case "pause":
			err = client.Pause()
